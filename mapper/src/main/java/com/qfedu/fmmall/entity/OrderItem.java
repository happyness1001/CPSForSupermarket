...
public class OrderItem {
    ...
    public OrderItem(String itemId, String orderId, String productId, String productName, String productImg, String skuId, String skuName, BigDecimal bigDecimal, int cnum, BigDecimal bigDecimal1, Date date, Date date1, int i) {
    }
